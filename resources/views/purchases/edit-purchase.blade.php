        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('purchase.update', $purchases->name) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="quantity" class="form-control" id="exampleInputEmail1" placeholder="Enter prefered quantity">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Supplier</label>
                                    <input type="text" name="supplier" class="form-control" id="exampleInputEmail1" placeholder="Enter supplier">
                                </div>
