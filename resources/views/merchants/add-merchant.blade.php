...
{{--                            </div>--}}
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('merchant.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Merchant Address</label>
